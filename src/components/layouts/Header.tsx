  ...
  return (
    <header className="bg-white w-full">
      <div className=" bg-sky-300">
        {/* <Image src="/img/logo.jpeg" alt="" height={60} width={120} /> */}

        <Sheet>
          <SheetTrigger>
            <div className="text-3xl py-5 px-3 cursor-pointer">
              <HiMenuAlt2 />
            </div>
          </SheetTrigger>
          <SheetContent className="bg-sky-200 px-2 w-[300px]">
            <SheetHeader>
            ...
            <section className="px-2">
              <h2 className=" text-xl font-bold mt-5 mb-2 text-left">
                自己紹介
              </h2>
